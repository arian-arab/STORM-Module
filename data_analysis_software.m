...
uimenu(modules_menu,'Text','Single Particle Tracks Tiff Image Layover (Colocalization)','Callback',{@spt_layover_colocalization});
uimenu(modules_menu,'Text','Single Particle Tracks Tiff Image Layover (Max Distance)','Callback',{@spt_layover_max_dist});
