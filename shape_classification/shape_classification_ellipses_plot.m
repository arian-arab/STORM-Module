...
answer = inputdlg({'Classes to Plot:','Radius of Ellipses:','Scatter Clusters in Class (1 or 0):','Show Error Bar (0 or1):','Show Data Table (0 or 1):','Show Percentage on Ellipses (0 or 1):','Weight for Total Number of Clusters (0 or 1):'},'Input',[1 50],{['1:',num2str(number_of_classes)],'1','0','0','0','0','0'});
if isempty(answer)~=1    
    ...
    text_plot = str2double(answer{6});  % if set to 1 shows percentage on ellipses
    weight = str2double(answer{7}); % if set to 1 all the statistics will be normalized to the total number of clusters
    if weight == 0
    ...
    shape_classification_ellipses_plot_inside(data,classes_color_statistics,classes_feature_statistics,to_plot,ellipses_radius,scatter_clusters,show_errorbar,show_table,text_plot)
end
end

function shape_classification_ellipses_plot_inside(data,classes_color_statistics,classes_feature_statistics,to_plot,ellipses_radius,scatter_clusters,show_errorbar,show_table,text_plot)
...
for i = 1:length(to_plot)
    ...
    nice_ellipse(x_c,y_c,x_r,y_r,ellipse_percentage(to_plot(i),:),c_map,text_plot)
...
function nice_ellipse(x0,y0,r1,r2,percentage,c_map,text_plot)
